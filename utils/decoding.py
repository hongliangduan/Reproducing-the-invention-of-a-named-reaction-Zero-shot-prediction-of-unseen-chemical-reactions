...
def log_decode_results(inputs,
  ...
  if is_image and save_images:
    ...
    if identity_output:
      ...
      print("111111111111111111111111111111111111111111111111111111111111111 This is decoded_inputs：")
      print(decoded_inputs)

    if log_results and not is_video:
      tf.logging.info("22222222222222222222222222222222222222222 This is inputs.")
  ...
  if identity_output:
    ...
    tf.logging.info("3333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333 This is outputs.")
    tf.logging.info(outputs)    #[0] or [1]
  ...
  if not is_video:
    tf.logging.info("Inference results OUTPUT: %s" % decoded_outputs)    # entailment or not entailment
...
def decode_from_file(estimator,
  ...
  def input_fn():
    ...
    print(sorted_inputs[1][3])
    print(sorted_inputs[1][4])
